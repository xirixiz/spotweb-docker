export IMAGE_NAME?=xirixiz/spotweb-docker
export APP_VERSION=`curl -Ssl 'https://api.github.com/repos/spotweb/spotweb/releases/latest' | jq -r .tag_name`
export VCS_REF=`git rev-parse --short HEAD`
export VCS_URL=https://github.com/xirixiz/spotweb-docker
...
.PHONY: build spotweb qemu wrap push manifest clean

spotweb:
	@echo "==> Fetching Spotweb version $(APP_VERSION)."
	-mkdir -p tmp/spotweb
	-mkdir -p src/spotweb
	cd tmp/spotweb && \
